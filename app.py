...
def call_gemini(prompt):
    ...
    """
    try:
        # Enhanced prompt instructions for clear, precise response
        full_prompt = (
            "IMPORTANT RESPONSE GUIDELINES:\n"
            "1. Provide a clear, concise, and direct answer\n"
            "2. Use full sentences with proper grammar\n"
            "3. Avoid markdown, special characters, or unnecessary formatting\n"
            "4. If the exact answer is not in the context, state 'Based on the available information, I cannot provide a definitive answer'\n"
